...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class ComplexDialogBot : IBot
    {
        ...
        private const string HelpSelected = "value-helpSelected";

        private static string[] _helpOptions = new string[]
        {
            "Microwaves", "Study Area", "Power Outlets",
        };
        ...
        private static async Task<DialogTurnResult> ChoiceStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            stepContext.Values[HelpSelected] = list;
            ...
            List<string> options = _helpOptions.ToList();
        ...
        private static async Task<DialogTurnResult> LocationAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            //((UserProfile)stepContext.Values[UserInfo]).Microwave = ((Choice)stepContext.Result).Value; 
            return await stepContext.PromptAsync("confirm", new PromptOptions { Prompt = MessageFactory.Text("Can I get your current location?") }, cancellationToken);
        }

        // public async Task<DialogTurnResult> MessageReceivedStart(WaterfallStep context, CancellationToken cancellationToken)
        // {
        //     var message = await argument;

        //     var apiKey = "VpQQm9K0B8hs3iJn2Shp0fsS1G6pF5q0p7CkapIXZYo";
